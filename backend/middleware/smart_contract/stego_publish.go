...
type stegoPayload struct {
	SchemaVersion int                  `json:"schema_version"`
	Proposal      stegoProposalPayload `json:"proposal"`
	Tasks         []stegoTaskPayload   `json:"tasks,omitempty"`
	Metadata      []stegoMetadataEntry `json:"metadata,omitempty"`
}

type stegoProposalPayload struct {
	ID               string `json:"id"`
...
type stegoMetadataEntry struct {
	Key   string `json:"key"`
