...
Environment (common):
  ...
  STARGATE_METRICS, STARGATE_PPROF  (opt-in, loopback-only; unset = off)
...
func effectiveConfig() map[string]any {
	...
	paths := map[string]string{
		...
		"IPFS_IDENTITY_FILE":     "ipfs_identity.key",
	...
	out := map[string]any{
		...
		"STARGATE_METRICS":           envOr("STARGATE_METRICS", "false"),
		"STARGATE_PPROF":             envOr("STARGATE_PPROF", "false"),
		"IPFS_ENABLED":               envOr("IPFS_ENABLED", "true"),
		"IPFS_WISH_TOPIC":            envOr("IPFS_WISH_TOPIC", "stargate-wishes"),
